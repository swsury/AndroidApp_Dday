...
class DdayStyle4TransparentWidgetProvider : AppWidgetProvider() {

    companion object {
        private const val TAG = "Style4TransparentWidget"
        ...
        fun updateAppWidget(
            ...
            try {
                ...
                val ddayId = widgetPrefs.getLong("widget_style4_transparent_${appWidgetId}_dday_id", -1L)
                val views = RemoteViews(context.packageName, R.layout.widget_dday_style4_transparent)
        ...
        fun updateAllWidgets(context: Context) {
            try {
                ...
                val appWidgetIds = appWidgetManager.getAppWidgetIds(
                    ComponentName(context, DdayStyle4TransparentWidgetProvider::class.java)
                )
    ...
    override fun onDeleted(context: Context, appWidgetIds: IntArray) {
        ...
        appWidgetIds.forEach { editor.remove("widget_style4_transparent_${it}_dday_id") }
        editor.apply()
    }
}
