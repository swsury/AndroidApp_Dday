...
class DdayStyle4WidgetProvider : AppWidgetProvider() {

    companion object {
        private const val TAG = "Style4Widget"
        ...
        fun updateAppWidget(
            ...
            try {
                ...
                val ddayId = widgetPrefs.getLong("widget_style4_${appWidgetId}_dday_id", -1L)
                val views = RemoteViews(context.packageName, R.layout. widget_dday_style4)
        ...
        fun updateAllWidgets(context: Context) {
            try {
                ...
                val appWidgetIds = appWidgetManager.getAppWidgetIds(
                    ComponentName(context, DdayStyle4WidgetProvider::class.java)
                )
    ...
    override fun onDeleted(context: Context, appWidgetIds: IntArray) {
        ...
        appWidgetIds. forEach { editor.remove("widget_style4_${it}_dday_id") }
        editor.apply()
    }
}